...
const articleMap = [
  {
    ...
    body: `
      ...
      <p>Quantity was the biggest demand‐driver in the soybean oil market, but in recent years, that's begun to shift to quality. Today’s high oleic soybeans — those with higher oleic acid content that eliminates the need for hydrogenation, thus making them an excellent alternative to conventional soybeans when processed for vegetable oil — fill the supply needs, with the required attributes. The identity‐preserved varieties available to farmers today meet consumer demand for cooking oil with desirable fat profiles while offering competitive agronomic performance and a premium farm price. In short, today’s HOSoy represents an opportunity for farmers to supply a domestic market they have created.</p>
  ...
  },
  {
    ...
    body: `
      ...
      <p><small><sup>1</sup> <em>Industry ARC; Soybean Oil Market – Forecast (2021 - 2026)</em><br/><sup>2</sup> <a href="https://www.feedandgrain.com/webinar/staying-ahead-of-the-high-oleic-soybean-curve" target="_blank" rel="noopener">Staying Ahead of the High Oleic Soybean Curve</a> Feed&Grain Webinar, March 17, 2021</small></p>
      <p><small><em>This content is an excerpt of the High Oleic Soybean Oil: The Business and Agronomic Case to Meet Growing Demand white paper, Jan. 2022.</em></small></p>
    `,
