const hints = {
  'crop.rtm': () => 'What is your return to management cost? This is often referred to as cost of living and is calculated by adding all draws from the farm to you personally, and any items that would be on a budget to include health insurance, vehicle payments, etc. If you do not know this number, simply put $0 and the tool will analyze the differences between the crops equally. If you’d like to know more about how to calculate your return to management cost, visit <a href="https://agviewsolutions.com/free-tools/" target="_blank" rel="noopener" class="text-secondary-3 hover:text-secondary-4 underline">agviewsolutions.com/free-tools</a> for a tutorial and a spreadsheet/decision-making tool.',
  'crop.land': () => 'What is your land cost per acre? This should include all principal and interest payments on land, plus your total cash rent cost, divided by ALL of your acres, not just the acres being evaluated in this scenario. If you don’t know exactly, use a rough number and it will auto-populate for both sides.',
  'crop.tax': () => 'What is your farm’s property tax cost per acre? This should include property tax costs divided by ALL acres, not just the ones evaluated in this scenario.',
  ...
  'fieldOps.other': () => 'Other costs may include irrigation, ditching, tile, field walking crews, rock picking, etc. Please make sure these costs are accurately reflected between crop comparisons.',
